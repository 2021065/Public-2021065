...
Encoder_model = keras.models.load_model("./model/AE_500", custom_objects={"r_loss": r_loss })
Encoder_model.summary()


Metric_model = keras.models.load_model("./model/AE500_CML500")
...
OUTPUT_DIR = "F:/python_code/ML500_to_Clustering_C"
