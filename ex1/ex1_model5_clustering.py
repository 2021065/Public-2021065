...
for count,i in enumerate(feature_vector):
   df_mean0 = np.average(i,axis=0)
   print(df_mean0)

np.savez(
    "/home/takanolab/proglams_python/ex1/feature/ex1_model5_{}_test".format(Z_DIM),  # ファイル名
    a1=_feature_vector,
    a2=feature_vector,
    a3=Y_test
)
...
OUTPUT_DIR = "/home/takanolab/proglams_python/result/ex1_model5_{}".format(Z_DIM)
