...
plt.show()
model2.summary()
model2.save("/home/takanolab/proglams_python/ex1/model/ex1_model5_{}".format(Z_DIM))
'''
np.savez(
    "/home/takanolab/proglams_python/ex1/feature/ex1_model5_{}_train".format(Z_DIM),  # ファイル名
    x_train2,
    feature_vector,
    Y_test
)
